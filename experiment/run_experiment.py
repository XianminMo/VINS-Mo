...
# ================= 配置区域 =================
# 1. 数据集设置
BAG_PATH = "/home/linux/mxm/data/Euroc/V1_01_easy.bag" # 请修改为你实际的 bag 路径
LAUNCH_CMD = ["roslaunch", "vins_estimator", "euroc.launch", "--screen"]

# 2. 输出路径配置 (根据你的描述修改)
SOURCE_INIT_FILE = "/home/linux/mxm/output/test/vio_init_window.txt"
SOURCE_RUN_FILE  = "/home/linux/mxm/output/test/vins_closed_loop.tum"

# 3. 结果保存目录
RESULT_DIR = "/home/linux/mxm/output/experiments_initial/V101_test/window_0_3s/deep" 


# 5. 实验参数
SLICE_DURATION = 10.0   # 切片时长
STEP_SIZE = 5.0         # 步长
START_TIME = 0
END_TIME = 145
